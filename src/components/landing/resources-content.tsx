...
import type { ExternalArticle, FeaturedVideo, ResourcesPageData, ShortVideo } from "@/lib/cms/types";
...
export function ResourcesContent({
  ...
  const compactOffset =
    (showFeatured ? 1 : 0) + (showVideos ? 1 : 0) + (showArticles ? 1 : 0);
  ...
  return (
    <div className="bg-white">
      ...
      {showVideos ? (
        <ResourcesShortVideos compactTop={showFeatured} videos={shortVideos} heading={sectionHeadings.videos} />
      ) : null}
      {showArticles ? (
        <ResourcesEditorial
